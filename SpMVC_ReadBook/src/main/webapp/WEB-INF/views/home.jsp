...
<html lang="ko">
  <head>
    ...
    <link href="${rootPath}/static/css/index.css?ver=2020-09-20" rel="stylesheet" />
    ...
    <script src="${rootPath}/static/js/main-nav.js?ver=2020-09-26"></script>
