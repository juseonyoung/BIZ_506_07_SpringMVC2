...
public class BooksController {
	...
	public String detail(
		...
		String lDate = DateTimeFormatter.ofPattern("yyyy-MM-dd").format(lDateTime); //자바 1.8 이상만 사용가능
		
		String lTime = DateTimeFormatter.ofPattern("HH:mm:SS").format(lDateTime); //자바 1.8 이상만 사용가능
